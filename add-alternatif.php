...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="panel panel-primary">
      ...
      <div class="text3 text-center" style="font-size: 2vw;" data-aos="fade-right" data-aos-duration="700">Tambah Data Alternatif</div>
      <div class="panel-body">
        ...
        <form role="form" method="post" action="add.php">
          <div class="box-body" data-aos="fade-right" data-aos-duration="700">
            ...
            <div class="form-group mt-3">
              ...
              <input name="k1" id="k1" min="1000" class="form-control" placeholder="Pendapatan Orang Tua">
            </div>
            <div class="form-group mt-3">
          ...
          <div class="box-footer mt-3" data-aos-duration="700">
